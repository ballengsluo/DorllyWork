<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Base.AutoAllocation,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <div>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 基础资料 <span class="c-gray en">&gt;</span> 默认执行人设置 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <div id="edit" class="pt-5 pr-20 pb-5 pl-20" style="display:none;">
      <div class="form form-horizontal" id="editlist">
        ...
        <div class="row cl">
          <label class="form-label col-2"><span class="c-red">*</span>分配部门：</label>
          <div class="formControls col-4">
            <%=dept %>
          </div>
          <div class="col-3"></div>
        ...
        <div class="row cl">
          <label class="form-label col-2"><span class="c-red">*</span>分配用户：</label>
          <div class="formControls col-4">
              <input type="text" class="input-text required" id="UserName" readonly style="width:380px;" data-valid="isNonEmpty" data-error="请选择" />
              <a href="javascript:void();" class="btn btn-primary radius upload-btn" onclick="ChooseBasicCheck('UserNo', 'user')" >选择</a>
    ...
    <script type="text/javascript">
        function BandResuleData(temp) {
            ...
            if (vjson.type == "submit") {
                if (vjson.flag == "1") {
                    ...
                    showMsg("OrderType", "当前地区的工单内类型已设置执行人！", "1");
                }
                else {
                    layer.alert("数据操作出错！");
                }
        ...
        function submit() {
            if ($('#editlist').validate('submitValidate')) {
                ...
                submitData.RegionNoS = $("#RegionNoS").val();
                transmitData(datatostr(submitData));
            }
            return;
        }
