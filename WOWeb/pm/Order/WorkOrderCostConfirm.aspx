<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Order.WorkOrderCostConfirm,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 工单管理 <span class="c-gray en">&gt;</span> 工单费用复核 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div id="list" class="pt-5 pr-20 pb-5 pl-20">
	    <div class="cl pd-5 bg-1 bk-gray mt-5">
            ...
            <a href="javascript:;" onclick="confirm()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe6e1;</i> 复核/反审</a> &nbsp;&nbsp;
		    ...
		    状态&nbsp;<select class="input-text required size-S" style="width:80px" id="Status" data-valid="" data-error="">
                        ...
                        <option value='CONFIRM'>已复核</option>
		              </select>&nbsp;
    ...
    <script type="text/javascript">
        ...
        function confirm() {
            ...
            layer.confirm('确认要复核/反审吗？', function (index) {
                var submitData = new Object();
