<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Order.WorkOrderFee,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <div id="list" class="pt-5 pr-20 pb-5 pl-20">
	    <div class="cl pd-5 bg-1 bk-gray mt-5">
		    ...
		    工单日期&nbsp;<input type="text" class="input-text required size-S" id="MinFeeDate">&nbsp;
		    至&nbsp;<input type="text" class="input-text required size-S" id="MaxFeeDate">&nbsp;            
    ...
    <script type="text/javascript">
        ...
        function approve() {
            ...
            layer.confirm('确认要审核/反审吗？', function (index) {
                ...
                submitData.id = $("#selectKey").val();
                submitData.MinFeeDate = $("#MinFeeDate").val();
                submitData.MaxFeeDate = $("#MaxFeeDate").val();
        ...
        jQuery(function () {
            var MinFeeDate = new JsInputDate("MinFeeDate");
            MinFeeDate.setDisabled(false);
            MinFeeDate.setHeight("26px");
            MinFeeDate.setWidth("100px");
            MinFeeDate.setValue(getfirstday());

            var MaxFeeDate = new JsInputDate("MaxFeeDate");
            MaxFeeDate.setDisabled(false);
            MaxFeeDate.setHeight("26px");
            MaxFeeDate.setWidth("100px");
            MaxFeeDate.setValue(gettoday());
        });
